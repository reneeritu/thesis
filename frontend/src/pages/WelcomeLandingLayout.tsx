 ...
 */
export default function WelcomeLandingLayout() {
  ...
  return (
    <div className="flex min-h-screen min-w-full flex-col">
      ...
      <section
        className="relative z-0 border-t border-[#2a1f35] bg-gradient-to-b from-[#0a0712] to-[#0a0712] text-white"
        aria-label="Introduction"
      >
        <div className="mx-auto max-w-shell shell-px py-20 sm:py-28">
          <div className="max-w-4xl">
            <p className="max-w-3xl font-[Cormorant_Garamond,serif] text-[clamp(1.5rem,4vw,2.25rem)] font-medium leading-snug tracking-wide text-white">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end">
              <div className="flex flex-col">
                <Link
                  to="/register"
                  className="etch-outlined-press inline-flex justify-center border border-white bg-[#0a0a0a] px-6 py-2.5 font-mono text-small uppercase tracking-[0.2em] text-white transition hover:bg-white hover:text-[#0a0a0a] [touch-action:manipulation]"
                >
                  Enter the chain
                </Link>
